                            ...
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                <ul>
                                    ...
                                    @for ($i = 1; $i <= $books_len; $i++)
                                        <li><a href="/books/{{ $i }}">/books/{{ $i }}</a></li>
                                    @endfor

                                    @for ($i = 1; $i <= $booksotres_len; $i++)
                                        <li><a href="/bookstores/{{ $i }}">/bookstores/{{ $i }}</a>
                                        </li>
                                    @endfor
                                </ul>
                                ...
                                <ul>
                                    ...
                                    @for ($i = 1; $i <= $posts_len; $i++)
                                        <li><a href="/post/{{ $i }}">/post/{{ $i }}</a></li>
                                    @endfor

                                    {{-- @for ($i = 1; $i <= $comments_len; $i++)
                                    <li><a href="/comment/{{$i}}">/comment/{{$i}}</a></li>
                                    @endfor

                                    @for ($i = 1; $i <= $replies_len; $i++)
                                    <li><a href="/reply/{{$i}}">/reply/{{$i}}</a></li>
                                    @endfor --}}
                                </ul>
                                <!-- post comment reply -->

                                {{-- http://172.24.243.157:8000/comment/1~15 --}}
                                {{-- http://172.24.243.157:8000/reply/1~30 --}}
                            </div>
                        </div>
                    </div>
